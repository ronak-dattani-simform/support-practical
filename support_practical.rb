...
"".blank?
#It returns true for empty string and strings containing only whitespace.
#It returns false for true and true for any falsey conditions (i.e. nil and false)

present? # It is also a Rails method. It does the opposite of what #blank? does.
...
#dup is the duplicate value of the object, if we change the duplicate value original object will also change. This will not happen in deep_dup. In deep_dup if we change value of deep duplicate, the original object's value will be same as earlier and not changed.
...
#anonymous - we can check whether this module has name or not
M.name          # => "M" 
Module.new.name # => nil
...
"Hello world, this is engineer".truncate_bytes(15)                     # => "Hello world, this…"
"Hello world, this is engineer".truncate_bytes(15, omission: "***")    # => "Hello world, this***"      
